...
const sections: LegalSection[] = [
  ...
  },
  {
    ...
    body: [
      "Ce site n'utilise aucun cookie publicitaire, aucun traceur de mesure d'audience et aucun outil de suivi tiers. Aucun consentement préalable n'est donc requis, et aucun bandeau ne vous est imposé.",
